...
class UpdateLocationDialogFragment2(private val innerContext: Context, initialAddress: Address) : BaseDialogFragment(R.layout.fragment_dialog_update_location),
        ...
        alertDialog = activity?.let {
            MaterialAlertDialogBuilder(requireContext()).run {
                ...
                it.runOnUiThread {
                    ...
                    supportMapFragment?.getMapAsync(this@UpdateLocationDialogFragment2)
                }
                create()
            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        binding.locationSearchView.setOnQueryTextListener(object : OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                task.addOnSuccessListener { response: FindAutocompletePredictionsResponse ->
                    ...
                    with(binding) {
                        resultSearchLocation.visibility = VISIBLE
                        ...
                        binding.resultSearchLocation.apply {
                            ...
                            val recyclerAdapter = SearchLocationAdapter(innerContext).apply {
                                setCallBack(this@UpdateLocationDialogFragment2)
                            }
    ...
    private fun release() {
        with(binding) {
            resultSearchLocation.visibility = GONE
            streetTextInputLayout.visibility = VISIBLE
            cityTextInputLayout.visibility = VISIBLE
            postalCodeTextInputLayout.visibility = VISIBLE
            countryTextInputLayout.visibility = VISIBLE
            stateTextInputLayout.visibility = VISIBLE
    ...
    override fun onSearchItemClick(placeId: String) {
        ...
        binding.resultSearchLocation.visibility = GONE
                        ...
                        addressComponents?.let { addressComponents ->
                            addressComponents.asList().onEach { addressComponent ->
                                when {
                                    ...
                                    addressComponent.types.contains(Place.Type.POSTAL_CODE.name.lowercase(Locale.getDefault())) ||
                                    ...
                                    addressComponent.types.contains(Place.Type.STREET_ADDRESS.name.lowercase(Locale.getDefault()))
                                    -> {
                                    ...
                                    addressComponent.types.contains(Place.Type.STREET_NUMBER.name.lowercase(Locale.getDefault()))
                                    -> {
                                        if(binding.street.text.toString() == none) {
                                            binding.street.text?.clear()
                                        }
