package com.openclassrooms.go4lunch.view.shared;
...
public abstract class FirestoreAdapter<VH extends RecyclerView.ViewHolder>
    ...
    public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
        if (e != null) {
            Timber.tag(TAG).w(e, "onEvent:error");
            onError(e);
            return;
        }

        // Dispatch the event
        Timber.tag(TAG).d("onEvent:numChanges:" + documentSnapshots.getDocumentChanges().size());
